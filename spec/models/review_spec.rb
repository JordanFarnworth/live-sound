...
describe Review, type: :model do
  ...
  describe 'should have valid validations' do
    ...
    it { should validate_uniqueness_of(:reviewable_id).scoped_to(:reviewable_type, :reviewerable_id, :reviewerable_type) }
    ...
    it { should validate_inclusion_of(:workflow_state).in_array(%w[unpublished active]) }
  end
